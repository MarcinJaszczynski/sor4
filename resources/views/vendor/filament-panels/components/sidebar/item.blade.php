...
<li
    {{
        $attributes->class([
            ...
            // mniej spacingu dla kompaktowego wyglądu
            'flex flex-col gap-y-0.5' => $active || $activeChildItems,
        ])
    }}
>
    <a
        ...
        @endif
        @class([
            'fi-sidebar-item-button relative flex items-center justify-center gap-x-2 rounded-md px-1 py-1 outline-none transition duration-75 text-sm',
    ...
    >
        ...
        <span
            ...
            @endif
            @class([
                'fi-sidebar-item-label flex-1 truncate text-xs font-medium',
