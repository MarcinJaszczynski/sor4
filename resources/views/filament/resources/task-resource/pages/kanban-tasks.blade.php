                            ...
                            <div class="space-y-2 mb-3">
                                @if($task->assignees->isNotEmpty())
                                    <div class="flex items-start text-xs text-gray-600">
                                        <x-heroicon-m-user class="w-3 h-3 mr-1.5 mt-0.5 shrink-0" />
                                        <div class="flex flex-wrap gap-1">
                                            @foreach($task->assignees as $assignee)
                                                <span class="font-medium bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded-full">{{ $assignee->name }}</span>
                                            @endforeach
                                        </div>
                                    </div>
